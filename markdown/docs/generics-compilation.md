...
> This section talks about how the compiler handles generics, knowledge of this is not needed in order to program in Quark, but some may find it helpful to know.
